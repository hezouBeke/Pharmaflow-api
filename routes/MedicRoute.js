...
const medicalValidatoroptional = require("../validators/medicValidatorUpdate");
...
router.put("/:id", authorize(["admin"]), validate(medicalValidatoroptional), medicController.update);
